    ...
    <>
      ...
      <section className="py-12 sm:py-16">
        <Container className="max-w-3xl space-y-5 text-sm leading-7 text-muted-foreground">
          ...
          <p>
            Class payments are processed by {siteConfig.payments.processor}. Pulse CPR does not store credit or debit card numbers on this website. Payment details you enter on Aegis Pay are handled by that processor.
          </p>
          <p>
