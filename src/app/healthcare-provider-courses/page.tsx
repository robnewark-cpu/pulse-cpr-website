...
export default function HealthcareCoursesPage() {
  return (
    <CoursePage
      ...
      description="Christine Oldenburg, RN, an American Heart Association Instructor, teaches Pulse CPR healthcare provider courses to the standard Oklahoma hospitals, clinics, and credentialing offices expect. Choose initial or renewal tracks, including group sessions at your facility."
