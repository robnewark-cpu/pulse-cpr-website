...
- Class images: Basic Life Support ${siteConfig.url}${classGraphics.basicLifeSupport.src}; Heartsaver ${siteConfig.url}${classGraphics.heartsaver.src}; AED ${siteConfig.url}${classGraphics.aed.src}; First Aid ${siteConfig.url}${classGraphics.firstAid.src}.
`
}
...
Instructor: ${instructors[0].name}, ${instructors[0].role}
Images: Heartsaver ${siteConfig.url}${classGraphics.heartsaver.src}; Basic Life Support ${siteConfig.url}${classGraphics.basicLifeSupport.src}; AED ${siteConfig.url}${classGraphics.aed.src}; First Aid ${siteConfig.url}${classGraphics.firstAid.src}
